...
import com.project.korex.exchangeRate.dto.CurrencyRateDto;
...
public class CurrencyRateSaveService {
    ...
    public void saveCurrencyRateDaily(String currencyCode, int page) throws Exception {
        ...
        // 2. 크롤링 데이터 -> DTO 변환
        List<CurrencyRateDto> dtoList = rawDataList.stream()
        ...
        List<CurrencyRate> entities = dtoList.stream()
     ...
     */
    private CurrencyRateDto mapToDto(Map<String, String> map, String currencyCode) {
     ...
     * DTO -> Entity 변환
     */
    private CurrencyRate dtoToEntity(CurrencyRateDto dto) {
